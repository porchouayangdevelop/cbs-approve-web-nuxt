<template>
  <div class="min-h-screen flex">
    <!-- Left Side - Branding -->
    <div
        class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-600 via-emerald-700 to-emerald-800 relative overflow-hidden">
      ...
      <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div class="text-center">
          ...
          <p class="mt-3 text-sm text-gray-600 dark:text-gray-400">
            ...
            <NuxtLink to="/auth/login" class="font-medium text-emerald-600 hover:text-emerald-500">
              Sign in here
            </NuxtLink>
          </p>
        </div>
...
<!--                <span class="px-2 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400">Or sign up with coming soon...</span>-->
<!--              </div>-->
<!--            </div>-->
<!--          </div>-->
