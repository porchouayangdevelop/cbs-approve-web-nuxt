  ...
  <div class="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 dark:from-red-950 dark:via-orange-950 dark:to-yellow-950 flex items-center justify-center p-4">
    <div class="max-w-2xl w-full">
      <div class="text-center space-y-8">
        <!-- Error Code Display -->
        <div class="relative">
          <div class="text-8xl md:text-9xl font-black text-red-200 dark:text-red-800 select-none">
            403
          </div>
        ...
        <UCard class="max-w-md mx-auto text-left">
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-center justify-between">
              ...
              <UBadge :color="getRoleColor(currentUser?.role)" variant="soft" size="sm">
          ...
          <div class="space-y-4">
            <div>
              <div class="flex items-center justify-between mb-2">
                <span class="text-sm text-gray-600 dark:text-gray-400">Requested Resource:</span>
              </div>
              <div class="bg-gray-100 dark:bg-gray-700 rounded-md p-2">
                <code class="text-sm text-gray-800 dark:text-gray-200">{{ requestedPath }}</code>
              </div>
            </div>

            <div v-if="missingAccess.permissions.length > 0">
              <div class="flex items-center justify-between mb-2">
                <span class="text-sm text-gray-600 dark:text-gray-400">Missing Permissions:</span>
              </div>
            ...
            <div v-if="missingAccess.roles.length > 0">
              <div class="flex items-center justify-between mb-2">
                <span class="text-sm text-gray-600 dark:text-gray-400">Required Roles:</span>
              </div>
              <div class="flex flex-wrap gap-1">
                <UBadge
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-3">
              <div class="flex items-center justify-between">
                <span class="text-sm text-gray-600 dark:text-gray-400">Access Attempt:</span>
                <span class="text-sm text-gray-900 dark:text-white">{{ formatDate(new Date()) }}</span>
              </div>
              <div class="flex items-center justify-between mt-1">
                <span class="text-sm text-gray-600 dark:text-gray-400">Reason:</span>
                <span class="text-sm text-red-600 dark:text-red-400">{{ accessReason }}</span>
              </div>
            </div>
          </div>
        </UCard>
