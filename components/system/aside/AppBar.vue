...
<template>
  ...
  >
    <div class="flex items-center justify-between px-4 py-3">
      ...
      <div class="flex items-center space-x-4">
        ...
        <div class="hidden md:flex items-center space-x-3">
          ...
          <!-- Role Badge -->
          <UBadge
            :color="currentConfig.badgeColor || 'primary'"
            variant="soft"
            size="sm"
          >
            {{ displayRole }} Portal
      ...
      <div class="flex items-center space-x-3">
        ...
        >
          <UButton variant="ghost" size="sm" class="relative">
            ...
            <span
              v-if="currentConfig.notificationCount > 0"
          ...
          >
            ...
            <div class="hidden md:flex flex-col items-start">
              ...
              <span
                ...
                :class="currentConfig.roleTextColor"
              >
    ...
    <div
      ...
      class="md:hidden px-4 pb-3 border-t border-gray-200 dark:border-gray-700"
    >
      <UInput
        v-model="searchQuery"
        :placeholder="currentConfig.searchPlaceholder"
...
const userMenuItems = computed(() => {
  ...
  const specificItems =
    roleSpecificItems[roleValue as keyof typeof roleSpecificItems];
  if (specificItems) {
